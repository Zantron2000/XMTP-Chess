...
describe('Tests the generateMoves function', () => {
    ...
    describe('Tests the generateKnightMoves function', () => {
        ...
        it('Should not generate moves outside of the board', () => {
            ...
            const knightMoves1 = generateMoves(board, [0, 0], PIECE_COLORS.WHITE + PIECE_VALUES.KNIGHT);
            const knightMoves2 = generateMoves(board, [0, 7], PIECE_COLORS.WHITE + PIECE_VALUES.KNIGHT);
            const knightMoves3 = generateMoves(board, [7, 0], PIECE_COLORS.WHITE + PIECE_VALUES.KNIGHT);
            const knightMoves4 = generateMoves(board, [7, 7], PIECE_COLORS.WHITE + PIECE_VALUES.KNIGHT);
